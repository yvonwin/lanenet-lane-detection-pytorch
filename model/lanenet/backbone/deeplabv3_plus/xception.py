...
model_urls = {
    ...
    'xception':
    './local_utils/xception-b5690688.pth'  #'http://data.lip6.fr/cadene/pretrainedmodels/xception-b5690688.pth'
    #'xception': 'http://data.lip6.fr/cadene/pretrainedmodels/xception-b5690688.pth'
    #'xception': 'http://data.lip6.fr/cadene/pretrainedmodels/xception-43020ad28.pt'
}
...
def xception(pretrained=True, os=16):
    ...
    if pretrained:
        ...
        #     if ('itr' not in k and 'tmp' not in k and 'track' not in k)
        # }
